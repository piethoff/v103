...
\begin{table}[H]
    ...
    \end{tabular}
\end{table}
\noindent Diese Werte werden in Abbildung \ref{fig:plot3} aufgetragen und gemäß der Vorschrift aus Gleichung \eqref{eq:dubbi} 
...
\begin{equation}
    A = \frac{F}{48EI} = \SI{16.71e-3\pm0.13}{\per\meter\squared}
\end{equation}
...
und
\begin{equation}
    \symup{\Delta}E=\frac{mg}{48IA^2}\symup{\Delta}.
\end{equation}
